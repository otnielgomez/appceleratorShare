...
function hideIndicator(win) {
	if (indicatorVisible && win != null && indWin != null) {
		indWin.close();
		indicatorVisible = false;
	}
}

function showIndicator(win) {

	if (!indicatorVisible & win != null) {
...
function prettyDate(time) {
	var monthname = [L("MONTH1"), L("MONTH2"), L("MONTH3"), L("MONTH4"), L("MONTH5"), L("MONTH6"), L("MONTH7"), L("MONTH8"), L("MONTH9"), L("MONTH10"), L("MONTH11"), L("MONTH12")];
